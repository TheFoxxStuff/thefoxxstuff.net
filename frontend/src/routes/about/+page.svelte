<script>
  ...
  const about = {
    ...
    bio: `Привет! Я TheFoxxStuff — музыкальный продюсер из холодной Якутии. Родился в Якутске, и с тех пор музыка стала неотъемлемой частью моей жизни.
...
Каждый трек — это попытка передать ощущение жизни на краю света, где -50°C зимой и белые ночи летом формируют особое мировосприятие. Моя музыка — это мост между традициями Севера и современной электронной культурой.`,
    ...
    websiteInfo: `Это моё цифровое пространство, где я делюсь своей музыкой, мыслями и творчеством. Здесь вы найдёте все мои релизы, блог о процессе создания музыки, арты и многое другое. Сайт разработан с нуля и постоянно развивается, добавляются новые функции и возможности.`,
