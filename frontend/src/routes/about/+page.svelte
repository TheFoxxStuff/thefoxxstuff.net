<script>
  ...
  const about = {
    ...
    bio: `Привет! Я TheFoxxStuff — музыкальный продюсер из холодной Якутии. Родился в Якутске.`,

    websiteInfo: `Это моё цифровое пространство, где я делюсь своей музыкой, мыслями и творчеством. Здесь вы найдёте все мои релизы, блог о процессе создания музыки, арты и многое другое. Сайт разработал с нуля и он постоянно развивается, добавляю новые функции и возможности`,
